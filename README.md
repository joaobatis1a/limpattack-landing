...
dist/index.html
```
Isso já funciona pra ver o layout, mas alguns navegadores bloqueiam certos recursos (como o vídeo do trailer) quando o site é aberto via `file://`. Se algo não funcionar, use a Opção 2.
